...
class NotionClient:
    def __init__(self, access_token: Optional[str] = None):
        ...
        """
        self.access_token = (
            access_token if access_token else getenv("NOTION_TOKEN")
        )
        if not self.access_token:
            raise Exception(
                "No Notion access token provided!\n"
    ...
    def query_database(
        self, database_id: str, filter: Dict = {}, sorts: List[Dict] = []
    ...
    def create_database(
        self, parent: Dict, title: List[Dict], properties: Dict
    ) -> Dict:
    ...
    def create_page(
        self, parent: Dict, properties: Dict, children: List[Dict] = []
    ) -> Dict:
    ...
    def create_page_markdown(
        self, parent: Dict, properties: Dict, md_body: IO
    ):
        """
    ...
    def update_page(
        self, page_id: str, properties: Dict, archived: bool = False
    ) -> Dict:
    ...
    def search(
        self, query: str, sort: Dict = {}, filter: Dict = {}
    ) -> Generator[Dict, None, None]:
        ...
        if filter:
            data["filter"] = filter
        return self._paginated_request("search", data=data)
    ...
    def _request(
        ...
        req = Request(
            NOTION_API_URL + url_path, data=data_bytes, method=req_method
        )
